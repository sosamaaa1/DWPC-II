...
function getRandomImage() {
  ...
  var images =   ['https://0901.static.prezi.com/preview/v2/uyaxil4rk42hxhg3zahalyror36jc3sachvcdoaizecfr3dnitcq_3_0.png', 
...
router.get('/', function (req, res, next) {
  // Crea una imagen aleatoria JSON
